...
const test = () => {
	...
	while (answer !== 2) {
		switch (answer) {
			case 1: console.log("Please, try again.");
				answer = Number(input());
				break;
			case 2: console.log("Congratulations, have a nice day!");
				break;
			case 3: console.log("Please, try again.");
				answer = Number(input());
				break;
			case 4: console.log("Please, try again.");
				answer = Number(input());
				break;
